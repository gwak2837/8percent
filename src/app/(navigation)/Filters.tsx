    ...
    <div className="flex flex-col gap-8 whitespace-nowrap rounded-xl bg-gray-100 p-4 dark:bg-gray-800">
      ...
      {[
        ...
        <div key={filter.key}>
          ...
          <div className="grid max-h-[20vh] grid-cols-[repeat(auto-fill,minmax(90px,1fr))] gap-2 overflow-y-auto rounded-xl bg-white p-3 px-4 sm:max-h-[10vh] dark:bg-gray-700">
